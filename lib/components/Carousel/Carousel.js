...
const SwipeView_1 = require("@/components/SwipeView/SwipeView");
/**
 * 滑动容器组件
 *
 * @export
...
class Carousel extends React.PureComponent {
    ...
    render() {
        return (React.createElement(SwipeView_1.default, { preventDefaultTouchmoveEvent: true, onSwiping: this.swiping, className: className.container, onSwiped: this.swiped },
            React.createElement("div", { style: { flexDirection: this.props.direction === "horizontal" ? "column" : "row" }, className: className.contentBody }, this.contentBody.map((element, index) => {
